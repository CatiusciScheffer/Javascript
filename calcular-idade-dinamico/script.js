...
function verificar() {
    ...
    if (ano_nascimento.value > ano || ano_nascimento.value.length == 0 || ano_nascimento.value < (ano - 120)){
        ...
        if (fsex[0].checked){//se o sexo masculino estiver marcado
            ...
            if(idade >= 0 && idade < 10){
                genero = 'Menino'
                img.setAttribute('src', 'criancamenino.jpeg')
            }else if(idade < 16){
                genero = 'um Adolescente'
                img.setAttribute('src', 'adolesmenino.jpeg')
            }else if(idade < 30){
                img.setAttribute('src', '20menino.jpeg')
            }else if(idade < 50){
                img.setAttribute('src', '40homem.jpeg')
            }else if(idade < 70){
                img.setAttribute('src', '60homem.jpeg')
            }else if(idade < 120){
                img.setAttribute('src', '80homem.jpg')
            }
            ...
            if(idade >= 0 && idade < 10){
                ...
                img.setAttribute('src', '20mulher.jpeg')
            }else if(idade < 50){
                img.setAttribute('src', '40mulher.jpeg')
            }else if(idade < 70){
                img.setAttribute('src', '60mulher.jpeg')
            }else if(idade < 120){
                img.setAttribute('src', '80mulher.jpg')
            }
        }
